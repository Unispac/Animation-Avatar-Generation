...
def loadImages(dataset_filepath):
...
def load_mnist(dataset_name):
    ...
    return X / 255., y_vec
"""
def checkFolder(log_dir):   #查看是否有这个目录，如果没有就创建
...
"""
def saveImages(images, size, image_path):
...
def spectral_norm(w, name="snorm" ,iteration=1):
    with tf.variable_scope(name) :
